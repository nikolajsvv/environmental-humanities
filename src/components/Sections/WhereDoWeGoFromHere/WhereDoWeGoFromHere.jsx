...
import backgroundImage17 from '../../../assets/Images/WhereDoWeGoFromHere/streets.webp'
...
import essay12 from'../../../assets/Submissions/WhereDoWeGoFromHere/Essay/the_streets_were_all_but_depleted-eric_bear.json'
import essay13 from '../../../assets/Submissions/WhereDoWeGoFromHere/Essay/the_buy-in_for_climate-kevin_duan_.json'
import essay14 from '../../../assets/Submissions/WhereDoWeGoFromHere/Essay/fear_of_possession-ronan_esperanza.json'
import imageSubmission1 from '../../../assets/Submissions/WhereDoWeGoFromHere/Images/the_willow_tree-sabrina_ahmed.jpeg'
import imageSubmissionContent1 from '../../../assets/Submissions/WhereDoWeGoFromHere/Images/the_willow_tree-sabrina_ahmed.json'
...
import poem2 from '../../../assets/Submissions/WhereDoWeGoFromHere/Poem/i_opened_the_door_for_a_fly-camryn_carmouche.json'
  ...
  <section id='where-do-we-go-from-here' style={{marginBottom: '100px'}} className='pt-40'>
    ...
    <div className="min-h-screen px-8 mx-auto xl:px-5 max-w-screen-2xl py-3 lg:py-4">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:row-span-2 lg:col-span-2">
          <PoemComponent content={poem2} backgroundImage={backgroundImage7}/>
        </div>
        <EssayComponent content={essay11} backgroundImage={backgroundImage14}/>
        <EssayComponent content={essay12} backgroundImage={backgroundImage17}/>
        <div className="lg:col-span-2 lg:row-span-2">
          <ImageComponent backgroundImage={imageSubmission1} content={imageSubmissionContent1} />
        </div>
        <EssayComponent content={essay13} backgroundImage={backgroundImage17}/>
        <EssayComponent content={essay14} backgroundImage={backgroundImage17}/>
